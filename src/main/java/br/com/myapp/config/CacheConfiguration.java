...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            cm.createCache(br.com.myapp.domain.User.class.getName(), jcacheConfiguration);
            cm.createCache(br.com.myapp.domain.Authority.class.getName(), jcacheConfiguration);
            cm.createCache(br.com.myapp.domain.User.class.getName() + ".authorities", jcacheConfiguration);
